...
DantaDataList = list()
#파일 경로입니다.
bot_file_path = "/var/autotrade/KrStock_" + BOT_NAME + ".json"
...
CheckNewStock = dict()
#파일 경로입니다.
check_file_path = "/var/autotrade/KrStock_" + BOT_NAME + "_CheckNew.json"
...
if IsMarketOpen == True:
    ...
    if len(DantaDataList) < MaxStockCnt and CheckNewStock['IsCheck'] == 'N':
        ...
        #파일 경로입니다.
        StockData_file_path = "/var/autotrade/KrStockDataList.json"
