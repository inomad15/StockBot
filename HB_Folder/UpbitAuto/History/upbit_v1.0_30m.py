...
for ticker in Tickers:
    try: 
        ...
        if myUpbit.IsHasCoin(balances,ticker) == True:
            ...
            #30분봉 기준 RSI지표 70 이상이면서 수익권일때 분할 매도를 한다.
            if rsi30_min >= 70.0 and revenu_rate >= 2.0:
                ...
                if NowCoinTotalMoney < (CoinMaxMoney / 4.0):
                    ...
                    line_alert.SendMessage("30분봉 매도신호")
            ...
            #30분봉 기준 RSI지표 30 이하에서 빠져나왔을 때
            if rsi30_min_before <= 30.0 and rsi30_min > 30.0:
                ...
                if Total_Rate <= 50.0:
                    ...
                    line_alert.SendMessage("30분봉 매수신호")
            ...
            #30분봉 기준 RSI지표 30 이하에서 빠져나오면서 아직 매수한 코인이 MaxCoinCnt보다 작다면 매수 진행!
