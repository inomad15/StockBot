...
if rsi_before2 < 40 and macd_before2 < macd_s_before2 and macd_before3 > macd_before2 and macd_before2 < macd_now:
    ...
    line_alert.SendMessage("Bithumb 5분봉 MACD 상승반전 매수신호")
    ...
    # 매수 주문 로직
        ...
        line_alert.SendMessage("Bithumb 5분봉 0.004 BTC 매수와 매도 주문")
    ...
    print(f"매수 신호 (KST): 시간 {current_time}, 가격 {order_price}")
    line_alert.SendMessage("Bithumb 5분봉 RSI 상승반전 매수신호")
